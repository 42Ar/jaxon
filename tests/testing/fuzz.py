...
from .classes import ObjectForDill, CustomTypeReturnField, CustomDataclass
...
def build_fuzz_tree(rng, cur_depth: int, max_depth: int, all_objects: list[PyTree],
    ...
    if rng.random() < 0.2 and cur_depth < max_depth:
        ...
        custom_class = _choice(rng, [ObjectForDill, CustomTypeReturnField, CustomDataclass])
